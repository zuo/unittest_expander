...
The authors of *unittest_expander* are: Jan Kaliszewski (zuo) and the
Contributors whose `GitHub pull requests`_ have been merged into
the code repository.
...
external libraries or testing frameworks, others did not; some had
appealing, programmer-friendly interfaces, others felt more like
